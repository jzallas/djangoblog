...
# Get environment specific data from environmental variables
...
# Assume do not debug, unless the environment states otherwise
DEBUG = get_env_variable("DJANGO_DEBUG_MODE", False)
# Expecting a string delimited by commas
ALLOWED_HOSTS = get_env_variable("DJANGO_ALLOWED_HOSTS", "")
ALLOWED_HOSTS = ALLOWED_HOSTS.strip().split(',') if ALLOWED_HOSTS.strip() else []
